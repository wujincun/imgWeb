...
/******/ 	var hotCurrentHash = "e0165bb5ccbf9dc8479e"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var elevenGame = {
	    ...
	    moveToDestination: function moveToDestination(obj) {
	        var resultNum = obj.num,
	            result = obj.result,
	            _this = this,
	            $popArea = $('.popArea'),
	            $popMaterial = $popArea.find('.getMaterial');
	    ...
	    getCouponNum: function getCouponNum(result) {
	        var num;
	        switch (result) {
	            case "3":
	                num = 8;
	    ...
	    dataProcess: function dataProcess(data) {
	        var _this = this,
	            code = data.code,
	            resultNum;
	    ...
	    /*失败成功提示*/
	    sucOrFailHint: function sucOrFailHint(text) {
	        var $upImgHint = $('.upImgHint');
	...
	var CarouselAndHandleImg = {
	    ...
	    render: function render() {
	        ...
	        $.ajax({
	            ...
	            var carouselItem = _this.$carouselWrap.find('.carouselItem');
	            carouselItem.eq(1).addClass('active');
	            _this.$carouselTitle.text(carouselItem.eq(1).attr('data-title'));
	            /*轮播*/
	            for (var _i = 0; _i < _this.showNum; _i++) {
	                $carouselItems.eq(_i).clone(true).appendTo(_this.$carouselWrap);
	            }
	    ...
	    handleImgEle: function handleImgEle(data) {
	        var _this = this;
	        var $lastImg = $('#upload'),
	            len = data.length,
	            date = void 0,
	    ...
	    upload: function upload(basestr) {
	        var _this = this,
	            $popArea = $('.popArea'),
	            $failPop = $popArea.find('.upFail ');
	        $.ajax({
	...
	!function (a, b) {
	  ...
	  var c = [],
	    ...
	    var e;if (n.isArray(b)) n.each(b, function (b, e) {
	      c || $b.test(a) ? d(a, e) : cc(a + "[" + ("object" == (typeof e === "undefined" ? "undefined" : (0, _typeof3.default)(e)) && null != e ? b : "") + "]", e, c, d);
	    ...
	    return this.length;
	  }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(75) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
